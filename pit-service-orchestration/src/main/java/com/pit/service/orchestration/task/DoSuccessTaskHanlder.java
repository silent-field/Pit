 ...
 */
@Slf4j
public class DoSuccessTaskHanlder<I, R> extends AbstractTaskHandler<I, R> {


    public static final String TYPE = "success";

    public DoSuccessTaskHanlder(IService<I, R> service, IServiceLogService logService, IServiceBefore<I, R> serviceBefore) {
