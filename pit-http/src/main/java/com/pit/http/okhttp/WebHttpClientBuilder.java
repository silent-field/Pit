...
public class WebHttpClientBuilder {
    ...
    public WebHttpClientBuilder connectTimeout(int connectTimeout, TimeUnit timeUnit) {
        if (connectTimeout <= 0) {
            log.error(StringUtils2.format(TIMEOUT_THRESHOLD_CHECK_INFO, "connectTimeout"));
            return this;
        }
    ...
    public WebHttpClientBuilder readTimeout(int readTimeout, TimeUnit timeUnit) {
        if (readTimeout <= 0) {
            log.error(StringUtils2.format(TIMEOUT_THRESHOLD_CHECK_INFO, "readTimeout"));
            return this;
        }
    ...
    public WebHttpClientBuilder writeTimeout(int writeTimeout, TimeUnit timeUnit) {
        if (writeTimeout <= 0) {
            log.error(StringUtils2.format(TIMEOUT_THRESHOLD_CHECK_INFO, "writeTimeout"));
            return this;
        }
