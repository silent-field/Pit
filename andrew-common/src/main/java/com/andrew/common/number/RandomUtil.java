package com.andrew.common.number;
...
/**
 * 随机数工具集. https://github.com/vipshop/vjtools/blob/master/vjkit/src/main/java/com/vip/vjtools/vjkit/number/RandomUtil.java
 *
 * <p>
...
public class RandomUtil {
	...
	public static int nextInt(Random random, int min, int max) {
		...
		Validate.isTrue(min >= 0, "Start value must bigger than 0.");
